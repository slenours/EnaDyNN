# File : train.py
"""
This is a training process for baseline model DGNet.
...
for i in range(1, epoch+1):
    ...
    for data in train_dataloader:
        ...
        outputs = model(imgs)
        outputs = outputs.view(outputs.size(0), outputs.size(1))  # reshape the output size to fit loss_function calculation
    ...
    torch.save(model, 'DGNet_{}'.format(i))  #Save the model in order to reuse it
