# File : experiment_Skip_DGNet

"""
This is an experiment file training the Skip_DGNet for 20 epochs for the purpose of
supporting the analyse of results in our report DyNN.
"""
...
file = open('.\_experiment_record2_1.txt', 'w', encoding='utf-8')
...
for i in range(1, epoch+1):
    ...
    torch.save(model, 'Skip_DGNet_{}'.format(i))
    ...
    file = open('.\_experiment_record2_1.txt', 'a', encoding='utf-8')
