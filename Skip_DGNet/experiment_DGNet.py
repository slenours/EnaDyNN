# File : experiment_DGNet

"""
This is an experiment file training the DGNet for 20 epochs for the purpose of supporting the analyse of results in our report DyNN.
"""
...
file = open('.\_experiment_record1_1.txt', 'w', encoding='utf-8')
...
for i in range(1, epoch+1):
    ...
    torch.save(model, 'DGNet_{}'.format(i))
    ...
    torch.save(checkpoint, 'checkpoint.pth1_1.tar')
    print('checkpoint is saved')

    file = open('.\_experiment_record1_1.txt', 'a', encoding='utf-8')
