# File : experiment_Noactivation_comment_code

"""
This is an experiment file training the Skip_DGNet for 20 epochs having no activation of gating functions
through comment out the code for the purpose of supporting the analyse of results in our report DyNN.
"""

import torchvision
from torch.utils.tensorboard import SummaryWriter
from Skip_DGNet_Noactivation_Comment_code import *
#from model import *
from torch.utils.data import DataLoader

file = open('.\_experiment_record3_1.txt', 'w', encoding='utf-8')
...
for i in range(1, epoch+1):
    ...
    torch.save(model, 'Skip_DGNet_Noac_comment_{}'.format(i))
    ...
    torch.save(checkpoint, 'checkpoint.pth3_1.tar')
    print('checkpoint is saved')

    file = open('.\_experiment_record3_1.txt', 'a', encoding='utf-8')
